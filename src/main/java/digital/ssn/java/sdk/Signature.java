...
public class Signature {
    ...
    public static boolean Verify(String message, String signature, String publicKey, String api, Integer timeOut) throws IOException {
        ...
        LOGGER.info("Verify response body : {} ", isVerified);
        return isVerified;
    }
    ...
    public static boolean VerifySigner(String signer, String ssnAccount, String api, Integer timeOut) throws IOException {
        ...
        // Gson parser
        Gson gson = new Gson();
        boolean isVerifiedSigner = false;
        ...
        LOGGER.info("VerifySigner request body : {} ", gson.toJson(reqBody));
        ...
        LOGGER.info("VerifySigner response body : {} ", isVerifiedSigner);
        return isVerifiedSigner;
    }
}
