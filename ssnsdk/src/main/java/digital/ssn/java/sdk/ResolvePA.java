...
public class ResolvePA {
    ...
    public static ResolverResponse ResolvePA(String paymentAddress, String hash, String signature, String ssnAcc, String resolverURL) {
        ...
        ResolverResponse payment = gson.fromJson(paBody, ResolverResponse.class);
        return payment;
    }
}